...
class CopyMoveSIFT: 
    ...
    def __init__(self,path):
        # Decode URL-encoded filesystem path to handle spaces and special characters
        try:
            import urllib.parse
        ...
        img_gray = cv.imread(decoded_path, cv.IMREAD_GRAYSCALE)
        img_rgb = cv.imread(decoded_path, cv.IMREAD_COLOR)
